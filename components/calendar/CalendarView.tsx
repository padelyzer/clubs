...
export function CalendarView() {
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      console.log('[Calendario] Fetching bookings with params:', params.toString())
  ...
  return (
    <>
        ...
        {loading ? (
          ...
          <FullCalendar
              ...
              dayCellDidMount={(info) => {
                ...
                indicatorsContainer.style.cssText = 'margin-top: 3px; display: flex; flex-direction: column; gap: 3px;'
                
                // Indicador de reservas
                if (activeEvents.length > 0) {
                  const reservasDiv = document.createElement('div')
                  reservasDiv.style.cssText = 'background: #D1FAE5; border-radius: 5px; padding: 2px 5px; font-size: 10px; font-weight: 500; color: #065F46; display: flex; align-items: center; gap: 2px;'
                  
                  const dot1 = document.createElement('div')
                  dot1.style.cssText = 'width: 5px; height: 5px; border-radius: 50%; background: #10B981;'
                ...
                disponibleDiv.style.cssText = `background: ${bgColor}; border-radius: 5px; padding: 2px 5px; font-size: 10px; font-weight: 500; color: ${textColor}; display: flex; align-items: center; gap: 2px;`
                
                const dot2 = document.createElement('div')
                dot2.style.cssText = `width: 5px; height: 5px; border-radius: 50%; background: ${dotColor};`
      ...
      <AppleModal
        ...
        title={selectedDayDate ? format(selectedDayDate, "EEEE, d 'de' MMMM yyyy", { locale: es }) : ''}
        maxWidth="600px"
      >
        <div style={{ padding: '20px' }}>
          {/* Day Stats */}
      ...
      <AppleModal
        ...
        title={selectedTimeSlot ? `${format(selectedTimeSlot.date, "EEEE, d 'de' MMMM yyyy", { locale: es })} - ${selectedTimeSlot.time}` : ''}
        maxWidth="700px"
      >
        {selectedTimeSlot && (
          <div style={{ padding: '20px' }}>
