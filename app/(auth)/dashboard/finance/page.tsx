...
import PayrollModuleDebug from './modules/PayrollModule-Debug'
import PayrollModuleSimple from './modules/PayrollModule-Simple'
import PayrollModuleWorking from './modules/PayrollModule-Working'
...
export default function FinancePageProfessional() {
  ...
  useEffect(() => {
    console.log('📊 useEffect triggered, activeModule:', activeModule)
  ...
  const fetchDashboardAnalytics = async () => {
    try {
      ...
      if (response.ok && data.analytics) {
        console.log('Finance analytics data:', data.analytics)
        console.log('Setting analytics with revenue:', data.analytics?.summary?.revenue)
  ...
  // Main return based on active module
  switch (activeModule) {
    case 'dashboard':
