    ...
    try {
      ...
      if (response.ok) {
        ...
        const mappedTransactions = (data.transactions || []).map((t: any) => {
          ...
          // First priority: Get from Booking if available
          if (t.Booking?.playerName) {
            playerName = t.Booking.playerName
          }
          // Second priority: Extract from description
          else if (t.description) {
            // Format: "Reserva de cancha - Juan Pérez"
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                <h3 style={{
                  ...
                  {searchQuery ? `Resultados de búsqueda: "${searchQuery}"` : `Transacciones (${totalTransactionsCount} total)`}
                </h3>
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button
                    style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ 
                          ...
                          <span>{transaction.playerName} • {transaction.category} • Ref: {transaction.reference}</span>
                        ...
                        <div style={{
                          ...
                          <button
                            ...
                            style={{
                              ...
                              border: '1px solid rgba(164, 223, 78, 0.2)',
                              background: 'white',
                              color: currentPage === 1 ? '#C4C4C4' : '#516640',
                              fontSize: '14px',
                          ...
                          <button
                            ...
                            style={{
                              ...
                              border: '1px solid rgba(164, 223, 78, 0.2)',
                              background: 'white',
                              color: currentPage === totalPages ? '#C4C4C4' : '#516640',
                              fontSize: '14px',
