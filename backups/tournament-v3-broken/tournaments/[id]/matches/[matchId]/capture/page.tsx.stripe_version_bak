          ...
          <div style={{ 
            ...
            {sets.map((set, setIndex) => (
              <div
                ...
                style={{
                  padding: '20px',
                  background: canSetWinner(setIndex) ? colors.success[50] : colors.neutral[50],
                  borderRadius: '12px',
                  border: `2px solid ${canSetWinner(setIndex) ? colors.success[200] : colors.neutral[200]}`
                }}
              >
                <div style={{ 
                  display: 'flex',
          ...
          <div style={{ 
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                background: winner 
                  ? `linear-gradient(135deg, ${colors.success[600]}, ${colors.success[500]})`
                  : colors.neutral[300],
                color: 'white',
                border: 'none',
                fontSize: '14px',
