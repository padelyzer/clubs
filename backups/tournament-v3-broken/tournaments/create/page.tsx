        ...
        <div style={{
          ...
          <CardModern variant="glass">
            <CardModernHeader>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Trophy size={18} />
                <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Información Básica</h3>
              </div>
            </CardModernHeader>
            <CardModernContent>
          ...
          <CardModern variant="glass">
            <CardModernHeader>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Calendar size={18} />
                <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Fechas del Torneo</h3>
              </div>
            </CardModernHeader>
            <CardModernContent>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <CardModern variant="glass">
            <CardModernHeader>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Users size={18} />
                <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Jugadores y Precios</h3>
              </div>
            </CardModernHeader>
            <CardModernContent>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <CardModern variant="glass">
            <CardModernHeader>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Trophy size={18} />
                <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Configuración del Partido</h3>
              </div>
            </CardModernHeader>
            <CardModernContent>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
