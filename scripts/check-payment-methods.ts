...
---`)
  ...
  if (transaction150) {
    ...
    if (transaction150.booking) {
      ...
      console.log('- Payments count:', transaction150.booking.payments.length)
      if (transaction150.booking.payments[0]) {
        console.log('- Payment method:', transaction150.booking.payments[0].method)
        console.log('- Payment status:', transaction150.booking.payments[0].status)
      }
      console.log('- Split payments count:', transaction150.booking.splitPayments.length)
    }
  }
}
