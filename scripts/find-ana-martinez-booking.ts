    ...
    bookings.forEach((booking, index) => {
      ...
      if (booking.splitPaymentEnabled) {
        ...
        if (booking.splitPayments.length > 0) {
          console.log('\n🔍 PAGOS DIVIDIDOS:')
          booking.splitPayments.forEach((splitPayment, spIndex) => {
          ...
          console.log(`📈 Progreso: ${completedPayments.length}/${booking.splitPaymentCount || booking.splitPayments.length}`)
      ...
      if (booking.transactions.length > 0) {
        ...
        booking.transactions.forEach((transaction, tIndex) => {
      ...
      if (booking.notifications.length > 0) {
        ...
        booking.notifications.forEach((notification, nIndex) => {
